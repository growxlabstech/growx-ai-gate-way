...
export const WEBHOOK_EVENT_CATALOG: readonly WebhookEventTypeMetadata[] = [
  // Gateway requests
  {
    ...
    category: "gateway",
    description:
      "Emitted when a customer AI gateway completion request finishes successfully",
  ...
  },
  {
    ...
    category: "subscription",
    description:
      "Emitted when an organization subscription is modified or upgraded",
    customerVisible: true,
  },
  {
    ...
    category: "subscription",
    description:
      "Emitted when an organization subscription is cancelled or scheduled to cancel",
    customerVisible: true,
  },
  {
    ...
    category: "subscription",
    description:
      "Emitted when a subscription successfully enters a new billing period",
    customerVisible: true,
  },
  {
  ...
  // Invoices & Billing
  {
    ...
    category: "billing",
    description:
      "Emitted when a commercial invoice is legally issued with final tax calculation",
    customerVisible: true,
  },
  {
    key: "invoice.paid",
    ...
    category: "billing",
    description:
      "Emitted when an invoice is fully settled with payment allocations",
    customerVisible: true,
  },
  {
    key: "invoice.voided",
  ...
  },
  {
    ...
    category: "billing",
    description:
      "Emitted when a credit note is issued against an existing invoice",
    customerVisible: true,
  },
  ...
  // Credits & Wallet
  {
    ...
    category: "usage",
    description:
      "Emitted when an organization credit balance drops below configured threshold",
    customerVisible: true,
  },
  {
    key: "credit.granted",
    ...
    category: "usage",
    description:
      "Emitted when new prepaid or recurring credits are granted to an organization wallet",
    customerVisible: true,
  },
  {
    key: "credit.expired",
    ...
    category: "usage",
    description:
      "Emitted when promotional or periodic credits reach expiration",
    customerVisible: true,
  },
  ...
  // Test Webhook
  {
    ...
    category: "test",
    description:
      "Synthetic test event triggered by the customer to verify endpoint connectivity",
    customerVisible: true,
  },
];

export function formatEventTypeName(
  key: string,
  version: string = "v1",
): string {
  return `${key}.${version}`;
...
export function matchesEventSubscription(
  ...
  if (
    subscribedPattern === "*" ||
    subscribedPattern === "*.*" ||
    subscribedPattern === eventTypeName
  ) {
    return true;
  }
