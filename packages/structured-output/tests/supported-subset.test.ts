...
import { validateSupportedSubset, UnsupportedSchemaKeywordError } from '../src/supported-subset.js';
...
describe('Supported JSON Schema Subset', () => {
  ...
  it('throws UnsupportedSchemaKeywordError in strict mode for disallowed keywords', () => {
    ...
    expect(() => validateSupportedSubset(unsupportedSchema, true)).toThrow(UnsupportedSchemaKeywordError);
  });
