export function Hero() {
  return (
    <section className="www-hero" id="gateway">
      ...
      <h1 className="www-headline">One gateway.<br />Every model.<br />Production control.</h1>
      <p className="www-hero-body">Connect your applications to one API and route across leading AI models with policy controls, observability, usage accounting, fallbacks and enterprise governance.</p>
      ...
      <div className="www-hero-actions">
        ...
        <a href="/docs" className="www-link-accent">Read the docs</a>
      </div>
      <p className="www-supporting">
        OpenAI-compatible APIs <span className="www-supporting-sep">{"\u00B7"}</span> streaming <span className="www-supporting-sep">{"\u00B7"}</span> tool calls <span className="www-supporting-sep">{"\u00B7"}</span> routing <span className="www-supporting-sep">{"\u00B7"}</span> fallbacks <span className="www-supporting-sep">{"\u00B7"}</span> usage controls
      </p>
    </section>
  );
}
