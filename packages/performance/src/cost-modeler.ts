...
export class InfrastructureCostModeler {
  public static calculateCostPerMillion(
    options: {
    ...
    const networkCost =
      (payloadBytes / (1024 * 1024 * 1024)) * 0.09 * 1_000_000; // $0.09 / GB
    const obsCost = 0.2; // Tracing & structured logs
    ...
    return {
      ...
      unitCostUsdPerRequest:
        Math.round((total / 1_000_000) * 100_000_000) / 100_000_000,
    };
  }
}
