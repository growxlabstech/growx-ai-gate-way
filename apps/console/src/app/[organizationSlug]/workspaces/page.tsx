    ...
    >
      <div className="toolbar workspace-toolbar">
        <label className="search-field">
          ...
          <input type="search" placeholder="Search workspaces…" />
        </label>
        ...
        <select aria-label="Filter by environment" defaultValue="all">
      ...
      <StatePanel
        ...
        detail="Create your first workspace to organize environments, API keys, usage and routing."
        action={
